...
* **[Aave Liquidation](milestone_1/aave.md)** — Aave Liquidation logic - TLV vs Liquidation Threshold 

### Milestone 2
* **[Historical ETH close price daily data](https://github.com/markurusov1/defischolar_research/blob/main/data/eth-usd-max.csv)** – Coingeko download, 2021–2026. 
## Navigation
- [View on GitHub](https://github.com/markurusov1/defischolar_research)